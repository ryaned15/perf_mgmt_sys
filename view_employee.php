...
$evaltype= $conn->query("SELECT * FROM designation_list where id = $designation_id ");
$evaltype = $evaltype->num_rows > 0 ? $evaltype->fetch_array()['designation'] : 'Unknown Evaluation Type';

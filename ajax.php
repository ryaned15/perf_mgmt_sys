...
#crud operations for command_list table
if($action == 'save_command'){
	$save = $crud->save_command();
	if($save)
		echo $save;
}
if($action == 'update_command'){
	$save = $crud->update_command();
	if($save)
		echo $save;
}
if($action == 'delete_command'){
	$save = $crud->delete_command();
	if($save)
		echo $save;
}
#crud operations for department_list table
...
#crud operations for designation_list table
...
#crud operations for employee_list table
...
#crud operations for evaluator_list table
...
#crud operations for task_list table
if($action == 'save_task'){
	$save = $crud->save_task();
	if($save)
		echo $save;
...
#crud operations for ratings table

  <aside class="main-sidebar sidebar-dark-secondary elevation-4">
    <div class="dropdown">
   	<a href="./" class="brand-link">
        ...
        <h3 class="text-center p-0 m-0"><b>Command Staff</b></h3>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
         <li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown">
            <a href="./index.php?page=pending_evaluations" class="nav-link nav-pending_evaluations">
          ...
          <li class="nav-item dropdown">
            <a href="./index.php?page=command_eval_view" class="nav-link nav-command_eval_view">
              <i class="nav-icon far fa-edit"></i>
              <p>
                Command Evaluation View
              </p>
            </a>
          </li>
        <?php endif; ?>
        ...
        <?php endif; ?>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./index.php?page=command_list" class="nav-link nav-command_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>List</p>
                </a>
              </li>

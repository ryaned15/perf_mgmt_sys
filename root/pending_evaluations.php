	...
	<div class="card card-outline card-secondary">
		<div class="card-header">
			...
			<div class="card-tools">
				<button class="btn btn-block btn-sm btn-default btn-flat border-secondary" id="new_task"><i class="fa fa-plus"></i> Initiate New Evaluation</button>
			</div>
			<?php elseif($_SESSION['login_type'] == 1): ?>
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-secondary" href="./index.php?page=new_evaluation"><i class="fa fa-plus"></i> Complete an Evaluation</a>
			</div>
			<?php endif; ?>
		</div>
		<div class="card-body">
						...
						<td class="text-center">
							<button type="button" class="btn btn-default btn-sm btn-flat border-info wave-effect text-info dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
		                      Action
			                    ...
			                    <?php if($_SESSION['login_type'] == 0): ?>
			                    <?php if($row['status'] != 2): ?>
			                    <a class="dropdown-item new_progress" data-pid = '<?php echo $row['pid'] ?>' data-tid = '<?php echo $row['id'] ?>'  data-task = '<?php echo ucwords($row['task']) ?>'  href="javascript:void(0)">Send to Evaluator</a>
		                    	 <div class="dropdown-divider"></div>
		                    	<?php endif; ?>
		                    	<?php endif; ?>

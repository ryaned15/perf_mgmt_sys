	...
	<div class="col-lg-12">
		<div class="row">
			<div class="col-md-6">
				...
				<dl>
					<dt><b class="border-bottom border-secondary">Assign To</b></dt>
					<dd><?php echo ucwords($name) ?></dd>
				</dl>
			</div>
			<div class="col-md-6">
				<dl>
					<dt><b class="border-bottom border-secondary">Due Date</b></dt>
					<dd><?php echo date("m d,Y",strtotime($due_date)) ?></dd>
				</dl>
				<dl>
					<dt><b class="border-bottom border-secondary">Status</b></dt>
					<dd>
						<?php 
			        	if($status == 0){
		...
		<div class="row">
			<div class="col-md-12">
				<dl>
				<dt><b class="border-bottom border-secondary">Description</b></dt>
